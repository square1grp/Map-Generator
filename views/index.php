    ...
    <form onsubmit="return false;">
      <div class="fieldset">
        ...
        <div id="sourceWrap" class="sourceWarp">
          <div class="tableize tableize-wrapper">
          ...
          <textarea id="sourceData" wrap="off" rows="5" cols="80" title="click to copy/paste, or drop your file here" spellcheck="false" autocomplete="off"></textarea>
        </div>
